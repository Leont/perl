...
Ap	|MAGIC*	|get_array_magic	|NN AV *av
...
p	|int	|magic_push	|NN AV* av|NN SV** values|I32 count|NN MAGIC* mg
p	|SV*	|magic_pop	|NN AV* av|NN MAGIC* mg
p	|int	|magic_unshift	|NN AV* av|NN SV** values|I32 count|NN MAGIC* mg
p	|SV*	|magic_shift	|NN AV* av|NN MAGIC* mg
p	|int	|magic_extend	|NN AV* av|I32 count|NN MAGIC* mg
p	|int	|magic_exists	|NN AV* av|I32 index|NN MAGIC* mg
p	|int	|magic_delete	|NN AV* av|I32 index|NN MAGIC* mg
p	|int	|magic_fill	|NN AV* av|I32 count|NN MAGIC* mg
